...
2) (Windows) Use [GUIFormat](http://ridgecrop.co.uk/index.htm?guiformat.htm) to format your flash drive as FAT32
2) (Linux) Use your tool of choice to format your flash drive as FAT32
2) (macOS) Open Disk Utility. Select your flash drive on the left, then "Erase". Choose "MS-DOS (FAT32)" from the dropdown, then click the "Erase" button.
