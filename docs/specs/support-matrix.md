...
| FlashForge Adventurer 5M | `adv5m-t113-family` | `supported` | `ad5m-bridge` | N32 sub-MCU details still need protocol-level verification. | Repo compatibility marks 5M/Pro working; package analysis also shows ARMv7 `MACHINE=Adventurer5M`, `PID=0023`, kernel-family `5.6.0-svn539`, and `NationsCommand`; confidence: `confirmed` |
| FlashForge Adventurer 5M Pro | `adv5m-t113-family` | `supported` | `ad5m-pro-bridge` | Pro-specific peripherals may require package/config deltas. | Repo compatibility marks 5M/Pro working ([../../README.md](../../README.md)); confidence: `confirmed` |
